...
class Hud:
    def __init__(self, screen):
        ...
        self.small_font = pygame.font.Font(os.path.join(os.path.dirname(__file__), "Jungle.otf"), 25)
    ...
    def draw(self, screen, counter, state):
        ...
        if state.click_multiplier > 1:
            bonus_text = self.small_font.render("3X MULTIPLIER!", True, self.bonus_color)
            bonus_shadow = self.small_font.render("3X MULTIPLIER!", True, self.shadow_color)
